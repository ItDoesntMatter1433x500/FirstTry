...
[data, head] = lab_read_edf('C:\YandexDisk\Project\Signals\29.edf');
...
s11=vertcat(data(1,:),data(2,:),data(3,:));
...
s22=vertcat(data(4,:),data(5,:),data(6,:));
...
s33=vertcat(data(6,:),data(7,:),data(8,:));
...
s44=vertcat(data(9,:),data(10,:),data(11,:));
...
s55=vertcat(data(11,:),data(12,:),data(13,:));
...
s66=vertcat(data(14,:),data(15,:),data(16,:));
...
lab_write_edf('C:\YandexDisk\Project\Signals\29f.edf',data,head);